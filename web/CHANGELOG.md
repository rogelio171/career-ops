...
## [0.4.0](https://github.com/rogelio171/career-ops/compare/web-v0.3.0...web-v0.4.0) (2026-07-21)


### Features

* experimental local-first web UI (opt-in alpha) ([#1451](https://github.com/rogelio171/career-ops/issues/1451)) ([1791dc4](https://github.com/rogelio171/career-ops/commit/1791dc4e3a14aeb10decd852c927bb636aefe00d))
...
* **pipeline:** optional per-offer note in the pipeline writer ([#1483](https://github.com/rogelio171/career-ops/issues/1483)) ([6435b1a](https://github.com/rogelio171/career-ops/commit/6435b1a4dc93a9d441df8768e481d878e3309ae3))
...
* **web:** Config microcopy humanized (P1.5) ([#1538](https://github.com/rogelio171/career-ops/issues/1538)) ([8ae3475](https://github.com/rogelio171/career-ops/commit/8ae347502b8380692a5f80f490bc59f20d1c8491))
* **web:** cost affordance — CostBadge muted (P1.6) ([#1536](https://github.com/rogelio171/career-ops/issues/1536)) ([b212bb3](https://github.com/rogelio171/career-ops/commit/b212bb3591de4c374347dec40fc400c4d6ab9bda))
* **web:** dedupe bug reports at write — stable fingerprint + click-gated similar-issue search ([#1473](https://github.com/rogelio171/career-ops/issues/1473)) ([e13a4f3](https://github.com/rogelio171/career-ops/commit/e13a4f37d6df9d21c0acca1d1716993df036e01d))
* **web:** empty-state free-scan button (P0.1) ([#1534](https://github.com/rogelio171/career-ops/issues/1534)) ([28f12e3](https://github.com/rogelio171/career-ops/commit/28f12e39e3e41104bb7a1f3650a0a508701f82fe))
* **web:** extract cleanChips to a tested module + tab/CR paste delimiter ([#1516](https://github.com/rogelio171/career-ops/issues/1516)) ([7e676f4](https://github.com/rogelio171/career-ops/commit/7e676f403e16c84231bb08669c79218615a88c83))
...
* **web:** orange hierarchy — brand-soft Mark-applied + inbox cost legend (P1.4) ([#1537](https://github.com/rogelio171/career-ops/issues/1537)) ([85d8290](https://github.com/rogelio171/career-ops/commit/85d829018c7b7225a1bbd547c53b817fd165924d))
* **web:** report progressive disclosure (P0.3+P1.8) ([#1535](https://github.com/rogelio171/career-ops/issues/1535)) ([30fa1d1](https://github.com/rogelio171/career-ops/commit/30fa1d19d00bf9a269adcef6778c52a1627d668c))
* **web:** richer bug-report diagnostics — data-shape fingerprint, core version, API errors ([#1469](https://github.com/rogelio171/career-ops/issues/1469)) ([6a13d8a](https://github.com/rogelio171/career-ops/commit/6a13d8a7a5448c5f488cac1631a1da471c070335))


### Bug Fixes

* correctness sweep across tracker, providers, and eval reporting ([#1528](https://github.com/rogelio171/career-ops/issues/1528)) ([bd2a44f](https://github.com/rogelio171/career-ops/commit/bd2a44f4ee1ea6c6def70200d7750969e67ebadf)), closes [#1527](https://github.com/rogelio171/career-ops/issues/1527)
...
* **web:** pin turbopack.root to prevent Windows postcss OOM ([#1530](https://github.com/rogelio171/career-ops/issues/1530)) ([8560153](https://github.com/rogelio171/career-ops/commit/8560153ad8aa37a3993418d32f951f25c868c6c4))
...
* **web:** restore the report-a-bug kit lost between the RC branch and main ([#1456](https://github.com/rogelio171/career-ops/issues/1456)) ([b11231f](https://github.com/rogelio171/career-ops/commit/b11231ffc77dfbd36b745b35df0b6ded3bb73720))
